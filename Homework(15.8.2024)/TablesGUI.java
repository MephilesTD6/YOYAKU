...
public class TableGUI extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        removeTablePane.add(tableLabelRemove, 0, 1);
        removeTablePane.add(tableFieldRemove, 1, 1);
        ...
        findTablePane.add(tableLabelFind, 0, 1);
        findTablePane.add(tableFieldFind, 1, 1);
        ...
        okBtn.setOnAction(e -> {
            ...
            db.insertTable(tableNumber,chairNumber); //inserts values into 'Reservations' table
        });
