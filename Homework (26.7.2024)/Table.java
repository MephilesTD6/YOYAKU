...
public class Table {
    ...
    // CONSTRUCTORS
    public Table(int tableNumber, int chairNumber, boolean status) {// object will be created when called with parameters
        this.tableNumber = tableNumber;// assigned to value of parameters passed through
        this.chairNumber = chairNumber;
        this.status = status;
        System.out.println("\nCreated a Table object with table number of " + tableNumber + " and number of chair " + chairNumber );
    }
